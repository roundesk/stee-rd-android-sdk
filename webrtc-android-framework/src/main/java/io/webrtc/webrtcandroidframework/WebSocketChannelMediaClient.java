...
import io.webrtc.webrtcandroidframework.apprtc.util.AsyncHttpURLConnection;
import io.webrtc.webrtcandroidframework.apprtc.util.AsyncHttpURLConnection.AsyncHttpEvents;
...
public class WebSocketChannelMediaClient {
  ...
  public WebSocketChannelMediaClient(Handler handler, WebSocketChannelEvents events, String roomID, String streamMode, String token) {
  ...
  public void sendPingPong() {
    ...
    handler.post(new Runnable() {
      ...
      public void run() {
        ...
        try {
          json.put(WebSocketRTCMediaClient.COMMAND, "ping");
  ...
  public void register() {
    ...
    JSONObject json = new JSONObject();
    try {
      json.put(WebSocketRTCMediaClient.COMMAND, streamMode);
      json.put(WebSocketRTCMediaClient.STREAM_ID, roomID);
      json.put(WebSocketRTCMediaClient.TOKEN_ID, token);
