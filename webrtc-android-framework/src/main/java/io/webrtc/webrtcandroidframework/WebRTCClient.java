...
import io.webrtc.webrtcandroidframework.apprtc.AppRTCAudioManager;
...
import io.webrtc.webrtcandroidframework.apprtc.PeerConnectionClient;

import static io.webrtc.webrtcandroidframework.apprtc.CallActivity.EXTRA_URLPARAMETERS;

/**
 * Activity for peer connection call setup, call waiting
 * and call view.
 */
public class WebRTCClient implements IWebRTCClient, MediaSignallingEvents, PeerConnectionClient.PeerConnectionEvents, IDataChannelMessageSender, IDataChannelObserver {
...
*/
    ...
    private void setStunUrlInIceServers(List<String> stunUrlList){
        for (String url : stunUrlList) {
